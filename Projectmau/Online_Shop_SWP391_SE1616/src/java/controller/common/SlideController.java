...
public class SlideController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Slider s = sdb.getSlideDetail(Integer.parseInt(sid));
        
        request.setAttribute("slide", s);
        request.getRequestDispatcher("/View/Public/slideSite.jsp").forward(request, response);
//        response.getWriter().print(s.getTitle());
    }
