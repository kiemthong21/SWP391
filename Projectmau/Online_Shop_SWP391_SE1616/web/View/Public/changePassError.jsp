<%-- 
    Document   : changePassController
    Created on : Jul 22, 2022, 2:46:25 AM
    Author     : Vu Dai Luong
--%>
        ...
        <div class="justify-center">
            <div class="wrapper">
                <div class="box">
                    <h1>Opps!!</h1>
                    <p>${error}</p>
                    <p><a href="http://localhost:8080/Online_Shop_SWP391_TuanVM/Homepage">Please, go back this way.</a></p>
                </div>
            </div>
    </body>
</html>
