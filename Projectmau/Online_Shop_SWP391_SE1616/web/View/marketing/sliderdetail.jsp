                ...
                <div class="content">
                    <div class="card mx-auto p-5">
                        <div class="mb-3 flex justify-between items-center">
                            <h1 class="text-xl font-medium">Detail Slider</h1>
                        </div>
                        <div class="mt-5" >
                            ...
                            <div class="mb-6">
                                ...
                                <div disabled id="category" name="status"
                                    ...
                                    <div>${slider.status.name}</div>

                                </div>
                            </div>
                            <img src="${pageContext.request.contextPath}/View/imgslider/${slider.img}" class="img-fluid" alt="...">

                            <div class="mb-6">
                                <label for="title" class="block mb-2 text-sm font-medium text-gray-900">title</label>
                                <input type="text" disabled id="title" name="title" value="${slider.title}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
                            </div>
                            <div class="mb-6">
                                <label for="title" class="block mb-2 text-sm font-medium text-gray-900">Backlink</label>
                                <input type="text" disabled id="title" name="title" value="${slider.content}" placeholder="Example: /ProductDetail?pid=?" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
                            </div>
                            <a type="submit" href="slidesredit?id=${slider.sliderID}" class="mt-5 ml-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Edit</a>
                        </div>
                    </div>
                </div>
