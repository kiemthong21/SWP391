        ...
        <div class="container">
            ...
            <div class="card mx-auto p-5">
                <div class=" mb-3 flex justify-between items-center">
                    <h1 class="text-xl font-medium">Edit Customer</h1>
                </div>
                <form class="mt-5" method="POST" enctype="editcustomer" id="form-post">
                    ...
                    <div>
                        <div class="mb-6">
                            ...
                            <input type="text" id="title" name="Name" value="${user.name}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
                        </div>
                        ...
                        <div class="form-floating"> 
                            <select class="form-select form-select-sm form-control mb-2" aria-label=".form-select-sm example" name="status">
                                <c:forEach items="${requestScope.status}" var="stt">
                                    <option value="${stt.getSettingID()}" ${user.status.settingID == stt.getSettingID() ? "selected" :"" }>${stt.getName()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="title" name="Phone" value="${user.phone}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
                        </div>
                        <div class="mb-6">
                            <label for="Email" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
                            <input type="email" id="title" name="Email" value="${user.email}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
                        </div>
                    </div>
