                        ...
                        <form class="mt-5" method="POST" enctype="multipart/form-data" id="form-post">
                            ...
                            <div>
                                <div class="mb-6">
                                    ...
                                    <input type="text" id="title" name="title" value="${post.postTitle}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
                                </div>
                                <div class="mb-6">
                                    <div>
                                ...
                                <div class="flex items-center mb-4">
                                    <c:forEach items="${status}" var="item">
                                        <div class="mr-3 flex items-center">
                                            <input name="status" id="status-${item.settingID}" ${post.postStatus.settingID==item.settingID ? "checked": ""} type="radio" value="${item.settingID}" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 focus:ring-2">
                                ...
                                <div class="mb-6 mt-6">
                                    ...
                                    <textarea id="description" name="summary" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Description...">${post.summary}</textarea>
                                </div>
                                <div>
