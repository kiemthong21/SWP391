                        ...
                        <form class="mt-5" method="POST" enctype="multipart/form-data" id="form-post">
                            ...
                            <div>
                                ...
                                <div class="mb-6 mt-6">
                                    ...
                                    <textarea id="description" name="summary" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Description...">${description}</textarea>
                                </div>
                                <div>
